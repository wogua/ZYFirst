...
public class LivePreviewWidgetCell extends WidgetCell {
    ...
    public void ensurePreview() {
        if (mPreview != null&& mActiveRequest == null) {
            Bitmap preview = generateFromRemoteViews(
                    (Activity) getContext(), mPreview, mItem.widgetInfo, mPresetPreviewSize, new int[1]);
            if (preview != null) {
     ...
     */
    public static Bitmap generateFromRemoteViews(Activity activity, RemoteViews views,
