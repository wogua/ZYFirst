...
public class LauncherAppWidgetProviderInfo extends AppWidgetProviderInfo {
    ...
    public void initSpans() {
        ...
        if (spanX < 0 || spanY < 0) {
            Log.e("LauncherDebug", "spanXY error *** spanX = " + spanX + ", spanY = " + spanY + ", label = " + label
                    + ", minWidth = " + minWidth + ", minHeight = " + minHeight + ", widgetPadding = [" +
                    widgetPadding.left + "," + widgetPadding.right + "," + widgetPadding.top + "," + widgetPadding.bottom+"]");
        }
