...
public class ZipIconGetter extends IconGetterAbsImpl{
    ...
    public boolean init(Context context) {
        ...
        mLabel_dimens = tp.getmLabel_dimens();
        Log.d(TAG, "mLabel_Icons size : " + mLabel_Icons.size()+", mLabel_colors size : " +mLabel_colors.size());
        Log.d(TAG, "mLabel_dimens size : " + mLabel_dimens.size()+", mLabel_dimens size : " +mLabel_dimens.size());
    ...
    protected Bitmap getLBEWaterMark() {
        if(lbeWaterMark == null){
            lbeWaterMark = getBitmapByName("ic_lbe_watermark.png");
        }
        if(lbeWaterMark == null){
            lbeWaterMark = super.getLBEWaterMark();
        }
        return lbeWaterMark;
    }
