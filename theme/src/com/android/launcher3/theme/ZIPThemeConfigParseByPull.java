...
public class ZIPThemeConfigParseByPull {
    ...
    private HashMap<String, Float> mLabel_dimens;
    ...
    public void parse(InputStream is) throws Exception {
        ...
        mLabel_dimens = new HashMap<String,Float>();
            ...
            switch (eventType) {
                ...
                case XmlPullParser.START_TAG:
                    if (parser.getName().equals("string-array")) {
                        ...
                        float intText = Float.parseFloat(text);
                        mLabel_dimens.put(parserName , intText);
...
//                        Log.d(TAG,"item parse end :");
    ...
    public HashMap<String, Float> getmLabel_dimens() {
        return mLabel_dimens;
    }
